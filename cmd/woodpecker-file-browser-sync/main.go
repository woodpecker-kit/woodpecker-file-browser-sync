...
import (
	...
	"github.com/woodpecker-kit/woodpecker-file-browser-sync"
	"github.com/woodpecker-kit/woodpecker-file-browser-sync/cmd/cli"
...
func main() {
	...
	pkg_kit.InitPkgJsonContent(woodpecker_file_browser_sync.PackageJson)
