...
import (
	...
	"github.com/woodpecker-kit/woodpecker-file-browser-sync/constant"
	"github.com/woodpecker-kit/woodpecker-file-browser-sync/file_browser_sync"
	"github.com/woodpecker-kit/woodpecker-file-browser-sync/internal/pkg_kit"
	"github.com/woodpecker-kit/woodpecker-file-browser-sync/internal/version_check"
...
var wdPlugin *file_browser_sync.FileBrowserSyncPlugin
...
func GlobalBeforeAction(c *cli.Context) error {
	...
	pluginBind, errBindPlugin := file_browser_sync.BindCliFlags(c,
		isDebug,
