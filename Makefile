...
ROOT_NAME?=woodpecker-file-browser-sync

## MakeDocker.mk settings start
ROOT_OWNER?=woodpecker-kit
ROOT_PARENT_SWITCH_TAG =1.24.7
...
ENV_GO_GODOC_EXPORT_PKG =github.com/woodpecker-kit/woodpecker-file-browser-sync/
...
## build args start
ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-file-browser-sync/main.go
ENV_ROOT_BUILD_PATH =build
